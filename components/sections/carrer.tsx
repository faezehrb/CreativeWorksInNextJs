      ...
      <div className="container mx-auto px-32 lg:px-20 md:px-10 min-h-screen grid content-center">
        <div className="backdrop-blur-md z-20 rounded-full p-3 mb-1">
          ...
          <div
              ...
              } grid place-items-center grid-cols-3 backdrop-blur-md rounded-2xl z-20 lg:grid-cols-2 md:grid-cols-1 gap-8 justify-items-center p-10`}
          >
              {/* {companies === undefined ? (
            <>Loading...</>
          ) : (
            companies.map((item) => (
              ...
              <div
                  className={`${nightMode ? null : "rainBow"} card min-h-[50vh] w-full lg:rounded-none flex items-center flex-col p-2 relative justify-center text-[1.5em] cursor-pointer`}>
                  <Link href='https://hamrahgold.com/' target='_blank'>
                      <Image
                          src="/img/hamrahgold.png"
                          width={70}
                          height={70}
                          alt="Picture of the author"
                          className='z-10 m-auto rounded-xl'
                      />
                      <p className='z-10 text-white text-center mt-4 text-gl'>HAMRAHGOLD</p>
                      <p className='z-10 text-white mb-4 text-center text-gl'>FRONT-END (PWA)</p>
                      <p className='z-10 text-white text-center text-sm'>
                          A comprehensive online platform for buying, selling, and investing in gold, offering real-time
                          prices and secure transactions.
                      </p>
                  </Link>
              </div>
              <div
                  className={`${nightMode ? null : "rainBow"} card min-h-[50vh] w-full lg:rounded-none grid place-items-center p-2 relative  text-[1.5em] cursor-pointer`}>
                  <Link href='https://sepanodata.ir/' target='_blank'>
                      ...
                      <p className='z-10 text-white  text-center text-sm'>A design and production of Windows and web
                          software company in cooperation with government organizations.</p>
                  </Link>
              ...
              <div
                  ...
                  <Link href='https://bimito.com/blog/' target='_blank'>
                      ...
                      <p className='z-10 text-white  text-center text-sm'>An online insurance shopping platform for
                          buying and renewing all types of insurance.</p>
                  </Link>
              </div>
              <div
                  className={`${nightMode ? null : "rainBow"} card min-h-[50vh] w-full lg:rounded-none flex items-center flex-col p-2 relative justify-center text-[1.5em] cursor-pointer`}>
                  <Link href='https://shoga.net/' target='_blank'>
                      ...
                      <p className='z-10 text-white mb-4 text-center text-gl'>FRONT-END</p>
                      <p className='z-10 text-white  text-center text-sm'>A factory for the domestic production and
                          export of glass jars and bottles.</p>
                  </Link>
              </div>
              <div
                  className={`${nightMode ? null : "rainBow"} card min-h-[50vh] w-full lg:rounded-none flex items-center flex-col p-2 relative justify-center text-[1.5em] cursor-pointer`}>
                  <Link href='https://dermavitrin.com/' target='_blank'>
                      ...
                      <p className='z-10 text-white mb-4 text-center text-gl'>FRONT-END</p>
                      <p className='z-10 text-white text-center text-sm'>A platform for buying and selling medical and
                          beauty equipment.</p>
                  </Link>
              </div>
          </div>
