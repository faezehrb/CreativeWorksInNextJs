  ...
  return (
    <div className="relative inline-block text-left">
      <div className='z-50'>
        <button
          type="button"
          className="inline-flex justify-center items-center backdrop-blur-md rounded-full m-2 w-20 h-20  text-white-800 transition transform border border-transparent hover:text-white-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-white-500 hover:scale-110 focus-visible:ring-opacity-50"
          ...
          <div className="relative w-8 h-8 rounded-full">
            <ul className="absolute inset-0 flex flex-col justify-center items-center list-none p-0 m-0">
              <li className = {`${clicked ? 'w-0 h-0 before:w-0 before:h-0' : 'w-[1.5rem] h-[1.5rem] before:w-[50px] before:h-[50px]'} transform transition-all translate-x-0 translate-y-[5.7rem] before:content-[''] before:bg-slate-300 before:absolute before:top-[-12px] before:left-[-12px] before:z-0 before:rounded-full before:blur-sm before:opacity-30`}>
                  <Link href="#" passHref>
                    <div className="rounded-full flex justify-center items-center text-white-800 transform transition-all" role="menuitem">
              ...
              <li className = {`${clicked ? 'w-0 h-0 before:w-0 before:h-0' : 'w-[1.6rem] h-[1.6rem]'} transform transition-all translate-x-[4.5rem] translate-y-[0.8rem] backdrop-blur-md rounded-full`}>
                <Link href="#" passHref>
                  <div className="rounded-full flex justify-center items-center text-white-800 transform transition-all" role="menuitem">
