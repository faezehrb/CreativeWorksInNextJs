    ...
    <div className="inline-block text-left fixed left-6 top-6 z-50">
      ...
      >
            <ul className="p-0 m-0">
              <li className = {`${clicked ? 'w-0 h-0' : 'w-[35px] h-[35px]'} absolute justify-center items-center place-items-center  top-0 left-24 transform transition-all hover:scale-110 backdrop-blur-2xl rounded-full duration-100`}>
              ...
              <li className = {`${clicked ? 'w-0 h-0' : 'w-[35px] h-[35px]'} absolute justify-center items-center place-items-center top-[4.3rem] left-20 transform transition-all hover:scale-110 backdrop-blur-2xl rounded-full duration-150`}>
                <Link href="#" passHref>
                  <div className="flex justify-center items-center  text-white-800" role="menuitem">
              ...
              <li className = {`${clicked ? 'w-0 h-0' : 'w-[35px] h-[35px]'} absolute justify-center items-center place-items-center top-24 left-1 transform transition-all hover:scale-110 backdrop-blur-2xl rounded-full duration-200`}>
